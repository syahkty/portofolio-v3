...
const ProfileImage = memo(() => (
  ...
  >
    <div className="w-72 h-72 sm:w-80 sm:h-80 lg:w-[420px] lg:h-[420px]">
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
        Saya adalah mahasiswa sistem informasi yang berfokus pada pengembangan Web dan Aplikasi. Saya berfokus pada penciptaan pengalaman digital yang terintegrasi, inovatif dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan.
                  </p>
